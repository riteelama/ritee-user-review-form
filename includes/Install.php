     ...
     class Install {
      ...
      /**
       ...
       public static function install() {
			...
			set_transient( 'ritee_user_review__form_installing', 'yes', MINUTE_IN_SECONDS * 10 );

			! defined( 'RITEE_USER_REVIEW_FROM_INSTALLING' ) && define( 'RITEE_USER_REVIEW_FROM_INSTALLING', true );
